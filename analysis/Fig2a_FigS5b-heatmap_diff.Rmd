...
R.devices::suppressGraphics({
    save_hm(hm_obj = hm, output_file = file.path(params$output_dir, glue("Fig2a-heatmap__diff_undirected.pdf")))
})
```
...
R.devices::suppressGraphics({
    save_hm(hm_obj = hm, output_file = file.path(params$output_dir, glue("FigS5b-heatmap__diff_undirected_w_annot.pdf")))
})
```
