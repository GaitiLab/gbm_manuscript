---
title: "Notebook to reproduce Figure S4i"
...
write.csv(correlation_df, paste0(params$output_dir, "/correlation_matrix_", curr_param, "_genes.csv"))
...
## Visualization
```{r, vis, fig.width = 8.5, height = 8}

pdf_output_path <- paste0(params$output_dir, "/correlation_heatmap_", genes, "_psuedobulked_patient_mean.pdf")
