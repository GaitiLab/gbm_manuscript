---
title: "Notebook to reproduce Figure S5c (right)"
...
ggsave(
    plot = p,
    filename = file.path(params$output_dir, glue("rank_plot_{source_target_oi_formatted}_in_{params$region_oi}.pdf")), height = 10, width = 10
)
```
