---
title: "Notebook to reproduce Figure 1i"
...
write.csv(df, file.path(params$output_dir, "samples_tested.csv"))
...
pdf(file = file.path(params$plot_dir, "deseq_disp_ests.pdf"), width = 10, height = 10)
plotDispEsts(deseq)
dev.off()
...
## Visualization
```{r, vis, fig.height = 10, fig.width = 7}
...
ggsave(filename = "volcano.pdf", path = params$plot_dir, height = 10, width = 7)
```
