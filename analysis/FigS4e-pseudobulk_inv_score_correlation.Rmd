---
title: "Notebook to reproduce Figure S4e"
date: "Last compiled on `r format(Sys.time(), '%d %B, %Y')`"
author: "Yiyan Wu"
params:
  input: "" 
  invis_sig: "misc/data/inv_sig.csv"
  output_dir: "output"
...
# Load seurat object
curr_seurat_data <- readRDS(params$input)
DefaultAssay(curr_seurat_data) <- "RNA"

# Invasive signature
inv_sig <- read.csv(params$invis_sig) %>% column_to_rownames("X")
...
## Visualization
```{r, vis, fig.width =32, fig.height=32}
p <- ggscatter(metadata_malignant,
  x = "invasivity", y = "invasive_score",
...
ggsave(paste0(params$output_dir, "/invasivity_invasive_score_correlation_malignant.pdf"), width = 12, height = 12, units = "cm")
```
