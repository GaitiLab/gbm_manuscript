...
expr_plot <- ExpressionPlot(
    ...
    scale_fill_manual(values = color_palette)
ggsave(
    filename = file.path(params$plot_dir, "FigS7e_ExpressionPlot_DLL3.pdf"),
    plot = expr_plot,
    width = 10,
    height = 10
)
...
ggsave(
    filename = file.path(params$plot_dir, "FigS7e_Combined_DLL3.pdf"),
    plot = combined,
    width = 7,
    height = 5
)
